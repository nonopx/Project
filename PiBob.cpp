...
int* PiBob::piTR = new int[5 * ((n / 32) + 1)];
...
int PiBob::Pi(int x, unsigned int* tr, unsigned int* ts, Block& temp_p_1S, Block& temp_p_1R, Block& temp_newS, Block& temp_newR, int indexresultTS, int indexTS, int countones, unsigned int randmine)

{
	...
	//	return 0;
	//}
	//else if (temp_newS.block == temp_p_1S.block && temp_newS.index == 1 && temp_p_1S.index == 1 && tr[0] == 0 && temp_newS.block[0] == 0)	// second round
	//{
	//	return 1;
	//}
...
int PiBob::piRand(int x, unsigned int* tr, unsigned int* ts, Block& temp_p_1S, Block& temp_p_1R, Block& temp_newS, Block& temp_newR, int indexresultTS, int indexTS, int countones, unsigned int randmine)
{
	int countBits = 0;
